...
public class FocusdataSystemTray : System.Windows.Forms.Form
{
   ...
   // private Icon mDirIcon = new Icon(typeof(FocusdataSystemTray).Assembly.GetManifestResourceStream("focusdata.ico"));
    ...
    private void InitializeNotifyIcon()
    {
        ...
        mnuItems[0] = new MenuItem("Log...", new EventHandler(this.Start_Click));
